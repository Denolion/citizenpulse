...
export default function SignupPage() {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    if (!terms) return;
    setLoading(true);
    // Simulated signup — replace with real Supabase call later.
    window.setTimeout(() => {
    ...
    <div>
      ...
      <div className="mb-8">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Join CitizenPulse and add your voice to the conversation.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5" noValidate>
        ...
        <div className="flex items-start gap-2">
          ...
          <Label htmlFor="terms" className="text-sm font-normal text-muted-foreground">
            ...
            <Link
              href="/terms"
              className="font-medium text-primary hover:text-primary/80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded"
            >
              Terms of Service
            </Link>{" "}
            and{" "}
